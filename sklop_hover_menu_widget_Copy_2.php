		...
		<div class="container-fluid">	
			<div class="row vcenter">
				...
				<div class="col-md-2">
					...
					$sklop_title_sluggified = str_replace( ' ' , '-' , strtolower($title) );
					...
					//Start new loop
					$args3 = array( 'post_type' => 'product', 'tax_query' => array(
						array(
							'taxonomy' => 'product_cat',
							'field' => 'slug',
							'terms' => $sklop_title_sluggified
							),
						), 'posts_per_page' => 1, 'orderby' => 'rand' );
						
					$loop = new WP_Query( $item->ID );
					while ( $loop->have_posts() ) : $loop->the_post(); 
					
						global $product;
						$sklop_placeholder_img_src = 'http://localhost/wordpress/wp-content/themes/estore-child/assets/images/lemonade7.jpg';
						
						if ($wimage!=""):?><img src="<?php echo $wimage?>"><?php endif; 
					endwhile;
					wp_reset_query();
					//End new loop 
					?>
